 ...
 * @package RH
 */
update_option( 'envato_purchase_code_5373914', 'nulled' );
update_option( 'inspiry_realhomes_registered', 'yes' );
// Theme version.
define( 'INSPIRY_THEME_VERSION', '3.11.1' );
...
if ( ! function_exists( 'inspiry_add_editor_style' ) ) :
	...
	function inspiry_add_editor_style() {
		...
		wp_enqueue_style(
			'rh-font-awesome',
			INSPIRY_COMMON_URI . 'font-awesome/css/all.min.css',
			array(),
			'5.13.1',
			'all'
		);

		$google_fonts = modern_fonts_url();
